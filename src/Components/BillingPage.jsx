...
const BillingPage = () => {
    ...
    const [products, setProducts] = useState([{ name: '', qty: 0, price: 0, discount: 0 }]);
    ...
    const handleProductChange = (index, field, value) => {
        ...
        updated[index][field] = ['qty', 'price', 'discount'].includes(field) ? Number(value) : value;
        setProducts(updated);
    };

    const addProduct = () => setProducts([...products, { name: '', qty: 0, price: 0, discount: 0 }]);
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 px-4">
                    <div className="bg-white rounded-lg p-4 sm:p-6 w-full max-w-md text-center shadow-xl max-h-screen overflow-y-auto text-sm sm:text-base">
                        <h2 className="text-lg sm:text-2xl font-bold mb-2 text-green-700">✅ Bill Created Successfully!</h2>
                        <p className="text-gray-600 mb-6">Your invoice has been saved and downloaded as PDF.</p>
